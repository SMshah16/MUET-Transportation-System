...
void getOfficialBusInfo() {
    ...
    // Corrected map definition, key is pair<string, string>
    map<pair<string, string>, string> busRoutes = {
        ...
        {{"Qasim Chouk", "morning"}, "S04"},
        {{"Qasim Chouk", "evening"}, "S04E"},
        {{"Kotri", "morning"}, "S05"},
        {{"Kotri", "evening"}, "S05E"},
        {{"Thandi Sarak", "morning"}, "S06"},
        {{"Thandi Sarak", "evening"}, "S06E"},
        {{"Pathan Colony", "morning"}, "S07"},
        {{"Pathan Colony", "evening"}, "S07E"},
        {{"Sindh University Society", "morning"}, "S08"},
        {{"Sindh University Society", "evening"}, "S08E"},
        {{"Phataq", "morning"}, "S09"},
        {{"Phataq", "evening"}, "S09E"},
        {{"Naseem Nagar", "morning"}, "S10"},
        {{"Naseem Nagar", "evening"}, "S10E"},
        {{"Saedabad", "morning"}, "S11"},
        {{"Saedabad", "evening"}, "S11E"}
    };
    
    cout << endl;
    cout << "=============================== Official Bus Information ===============================" << endl;
    cout << left << setw(25) << "Location" << setw(15) << "Timing" << setw(15) << "Route Code" << endl;
    cout << "-------------------------------------------------------------------------------" << endl;
    for (const auto& route : busRoutes) {
        cout << left << setw(25) << route.first.first  
             << setw(15) << route.first.second 
             << setw(15) << route.second << endl; 
    }
    ...
    if (busRoutes.count({location, timing})) {
        cout << "Based on your input, the recommended bus number is " << busRoutes[{location, timing}] << "." << endl;
    } else {
        cout << "Bus service is not available for this location at the specified time." << endl;
    }
}
